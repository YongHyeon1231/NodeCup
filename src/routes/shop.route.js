...
//       let cardNumberCountMax = 0;
//       for (let i = 0; i < cardsCount.length; i++) {
//         cardNumberCountMax = Math.max(cardsCount[i].cardNumber, cardNumberCountMax);
//       }
//       cardNumberCountMax++;

//       console.log("cardNumberCountMax => ", cardNumberCountMax);
...
//                 cardNumber: cardNumberCountMax + i
//               },
//             });
